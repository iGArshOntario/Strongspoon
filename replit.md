...
- **Product Catalog**: Allows browsing of dessert flavors with flat pricing — $12.99 per 250g cup (tax-included), $7 during the 24-hour launch window (April 10, 2026 8 AM – April 11, 2026 8 AM CST). No bundle system — flat rate per cup. Toppings are +$1 each (per topping selected).
- **Order Customization**: Customers can select from a variety of toppings at +$1 per topping selected (almonds, cashews, peanuts, raisins, walnut, apple, blueberries). Nutty Crumble is free until May 10 2026.
